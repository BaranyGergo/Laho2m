...
switch ($_GET['P']) {
	...
	case 'download': require_once PROTECTED_DIR.'normal/download.php'; break;
	case 'lovag': require_once PROTECTED_DIR.'normal/lovag.html'; break;
	case 'varazslo': require_once PROTECTED_DIR.'normal/varazslo.html'; break;
	case 'orvgyilkos': require_once PROTECTED_DIR.'normal/orvgyilkos.html'; break;
	case 'gyogyito': require_once PROTECTED_DIR.'normal/gyogyito.html'; break;
